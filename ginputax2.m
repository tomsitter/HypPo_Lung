function [out1,out2,out3,out4] = ginputax2(ax,escapePointer,arg1)
...
%	
%	This function was modified slightly from the original ginputax by Steven
%	Engler (July 2013)
...
if ~strcmp(tp,'none') && ~strcmp(tp,'x') && ~strcmp(tp,'micro'),
    if nargout == 1,
        if nargin == 3,
            out1 = trmginput(ax,escapePointer,arg1);
        elseif nargin == 2,
            out1 = trmginput(ax,escapePointer);
        elseif nargin == 1,
            out1 = trmginput(ax);
        else
            out1 = trmginput;
    ...
    elseif nargout == 2 || nargout == 0,
        if nargin == 3,
            [out1,out2] = trmginput(ax,escapePointer,arg1);
        elseif nargin == 2,
            [out1,out2] = trmginput(ax,escapePointer);
        elseif nargin == 1,
    ...
    elseif nargout == 3,
        if nargin == 3,
            [out1,out2,out3] = trmginput(ax,escapePointer,arg1);
        elseif nargin == 2,
            [out1,out2,out3] = trmginput(ax,escapePointer);
        elseif nargin == 1,
    ...
    elseif nargout == 4,
        if nargin == 3,
            [out1,out2,out3,out4] = trmginput(ax,escapePointer,arg1);
        elseif nargin == 2,
            [out1,out2,out3,out4] = trmginput(ax,escapePointer);
        elseif nargin == 1,
	...
	if nargin<=2
        escapePointer = libpointer('uint32');
		escapePointer.Value = 0;
	end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function key = wfbp(escapePointer)
...
try
    ...
    keydown = waitforbuttonpresswithescape(escapePointer);
